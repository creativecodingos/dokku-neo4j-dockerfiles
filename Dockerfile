...
RUN wget -O /var/neo4j-community-2.2.1-unix.tar.gz http://dist.neo4j.org/neo4j-community-2.2.1-unix.tar.gz

RUN tar -xvzf /var/neo4j-community-2.2.1-unix.tar.gz -C /var
RUN mv /var/neo4j-community-2.2.1 /var/neo4j
